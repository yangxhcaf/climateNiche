---
title: "Analyse the climatic niche of a species"
...
Download occurrence data from GBIF using the rgbif package. This approach is limited to 200000 data entries, so here we limit it to 200 entries, as data takes a long time to download.
...
Compare the climatic niche of multiple species using the most important bioclimatic variables (bio5, bio12, bio15) 
